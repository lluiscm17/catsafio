...
public class PartyHat extends ArmorItem {
    public PartyHat(ArmorMaterial pMaterial, Type pType, Properties pProperties) {
        ...
        consumer.accept(new IClientItemExtensions() {
            ...
            public HumanoidModel<LivingEntity> getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
                HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(),
                        Map.of("head", new CustomPartyHat(Minecraft.getInstance().getEntityModels().bakeLayer(CustomPartyHat.LAYER_LOCATION)).Head,
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
        return "catsafio:textures/entity/party_hat.png";
    }
}
