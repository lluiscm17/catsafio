...
public class Hat extends ArmorItem {
    public Hat(ArmorMaterial pMaterial, Type pType, Properties pProperties) {
        ...
        consumer.accept(new IClientItemExtensions() {
            ...
            public HumanoidModel<LivingEntity> getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
                HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(),
                        Map.of("head", new CustomHat(Minecraft.getInstance().getEntityModels().bakeLayer(CustomHat.LAYER_LOCATION)).Head,
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
        return "catsafio:textures/entity/hat.png";
    }
}
